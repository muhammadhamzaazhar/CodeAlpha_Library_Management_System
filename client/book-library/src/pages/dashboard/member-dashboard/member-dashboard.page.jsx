...
import "../admin-dashboard/admin-dashboard.styles.css";
        ...
        <div className="dashboard-option-content">
          ...
          <div className="member-activebooks-content" id="activebooks@member">
            ...
            <table className="activebooks-table">
              ...
              {memberDetails?.activeTransactions.length === 0 ? (
                <p className="no-data">No active books found</p>
              ) : (
          ...
          >
            ...
            <table className="activebooks-table">
              ...
              {memberDetails?.activeTransactions.length === 0 ? (
                <p className="no-data">No reserved books found</p>
              ) : (
                memberDetails?.activeTransactions
                  ?.filter((data) => {
          ...
          <div className="member-history-content" id="history@member">
            ...
            <table className="activebooks-table">
              ...
              {memberDetails?.prevTransactions.length === 0 ? (
